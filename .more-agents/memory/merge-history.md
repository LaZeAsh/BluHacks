...
## 2026-04-26T12:58:51.505481+00:00

PR analysis for #3.

PR #3: Expand recorder dashboard UI
...
README.md                 |   6 +--
 ...
 9 files changed, 35 insertions(+), 220 deletions(-)
...
## 2026-04-26T17:02:28.885046+00:00

PR analysis for #5.

PR #5: Use 2D landmark distance
...
.more-agents/memory/agent-ledger.md        |   1 -
 .more-agents/memory/architecture.md        |  11 ----
 .more-agents/memory/decisions.md           |   1 -
 .more-agents/memory/goal.md                |   3 -
 .more-agents/memory/merge-history.md       |  45 --------------
 ...
 pose_landmarker_full.task                  | Bin 9398198 -> 0 bytes
 requirements.txt                           | Bin 946 -> 601 bytes
 16 files changed, 38 insertions(+), 308 deletions(-)
